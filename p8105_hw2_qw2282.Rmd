...
dim(distinct_station)  #466 distinct stations that have different station name, route and lines.
...
brfss_smart2010 = janitor::clean_names(brfss_smart2010) %>% 
  ...
  mutate(proportion = (excellent + very_good) / (excellent + very_good + good + fair)) #Calculate the proportions and add it as a variable. 
